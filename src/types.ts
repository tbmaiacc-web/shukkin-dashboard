...
export const SHIFT_DISPLAY: Record<string, { label: string; className: string }> = {
  ...
  'アニ休':  { label: 'アニ', className: 'text-orange-500 bg-orange-50' },
  'AMアニ休':{ label: 'AMア', className: 'text-orange-400 bg-orange-50' },
  'PMアニ休':{ label: 'PMア', className: 'text-orange-400 bg-orange-50' },
